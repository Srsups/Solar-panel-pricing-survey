...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> calcularSistema() async {
    ...
    try {
      final url = Uri.parse('https://4def-2804-18-163-44dc-1d2c-bb10-867c-c49d.ngrok-free.app/calcular'); // colocar o ip do ngrok (não funciona com wifi empresarial, igual o da puc)
      final body = {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text('Usuário Exemplo', style: TextStyle(fontSize: 24)),
            SizedBox(height: 10),
            Text('usuario@email.com', style: TextStyle(fontSize: 16)),
            SizedBox(height: 30),
            ElevatedButton(
